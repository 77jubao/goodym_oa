 ...
 */
package cn.goodym.java.modules.act.service.ext;
...
import cn.goodym.java.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new cn.goodym.java.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new cn.goodym.java.modules.sys.entity.User(null, userId)))){
